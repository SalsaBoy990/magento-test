...
* All rights reserved
*/
namespace Gulacsi\Commercebug\Renderer;
...
class Json
{
    ...
    */
    public function clean($data)
    {
        ...
        foreach($data as $key=>$value)
        {
            if($key === 'invoked_observers')
            {
                $data[$key] = array_filter($value, function($val){
                    ...
                    return strpos($val['instance'], 'Gulacsi\\Commercebug') === false;
                });
            }
        ...
        {
            $data['layouts'] = [
                'graph'=> \Gulacsi\Commercebug\Plugins\MagentoFrameworkViewLayout::renderGraph(),
