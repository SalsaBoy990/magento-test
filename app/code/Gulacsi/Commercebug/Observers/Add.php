...
class Add extends AbstractObserver
{
    ...
    public function __construct(
        ...
        \Gulacsi\Commercebug\Model\LogFactory $logFactory,
        \Gulacsi\Commercebug\Model\RenderedData $renderedData,
        \Magento\Developer\Helper\Data $developerHelper,
        \Gulacsi\Commercebug\Renderer\JsonFactory $jsonFactory,
    ...
    protected function getCommerceBugData($observer)
    {
        ...
        $cb_data = \Gulacsi\Commercebug\Model\All::asData();
